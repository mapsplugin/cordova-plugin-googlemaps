...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event {
  ...
  UIView *wView = self.webView;  // prevent this stupid code https://github.com/ionic-team/capacitor/blob/792008faf5d3cf4fbcd958598fc08c42e3c0eedf/cli/src/ios/update.ts#L426-L439
  NSArray *subviews = [wView.superview subviews];
