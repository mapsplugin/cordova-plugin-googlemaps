...
public class PluginMap extends MyPlugin implements OnMarkerClickListener,
  ...
  public void syncInfoWndPosition() {
    ...
    String js = String.format(Locale.ENGLISH, "javascript:if(window.cordova){cordova.fireDocumentEvent('%s', {evtName: 'syncPosition', callback:'_onSyncInfoWndPosition', args:[{'x': %f, 'y': %f}]});}",
        mapId, ((float)point.x / density), ((float)point.y / density));
    jsCallback(js);
  }
