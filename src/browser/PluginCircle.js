...
PluginCircle.prototype.setTitle = function(onSuccess, onError, args) {
  var self = this;
...
PluginCircle.prototype.showInfoWindow = function(onSuccess, onError, args) {
  var self = this;
  var overlayId = args[0];
  var marker = self.pluginMap.objects[overlayId];
  if (marker) {
...
PluginCircle.prototype.setPosition = function(onSuccess, onError, args) {
  var self = this;
  var overlayId = args[0];
  var marker = self.pluginMap.objects[overlayId];
  if (marker) {
...
PluginCircle.prototype._onMarkerEvent = function(marker, evtName) {
  var self = this,
