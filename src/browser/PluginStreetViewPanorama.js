...
function PluginStreetViewPanorama(pluginMap) {
  var self = this;
...
PluginStreetViewPanorama.prototype._create = function(onSuccess, onError, args) {
  var self = this,
...
PluginStreetViewPanorama.prototype.setTitle = function(onSuccess, onError, args) {
  var self = this;
...
PluginStreetViewPanorama.prototype.showInfoWindow = function(onSuccess, onError, args) {
  var self = this;
  var overlayId = args[0];
  var marker = self.pluginMap.objects[overlayId];
  if (marker) {
...
PluginStreetViewPanorama.prototype.remove = function(onSuccess, onError, args) {
  var self = this;
  var overlayId = args[0];
  var marker = self.pluginMap.objects[overlayId];
  if (marker) {
...
PluginStreetViewPanorama.prototype._onMarkerEvent = function(marker, evtName) {
  var self = this,
