...
PluginTileOverlay.prototype.setTitle = function(onSuccess, onError, args) {
  var self = this;
...
PluginTileOverlay.prototype.showInfoWindow = function(onSuccess, onError, args) {
  var self = this;
  var overlayId = args[0];
  var marker = self.pluginMap.objects[overlayId];
  if (marker) {
...
PluginTileOverlay.prototype.setPosition = function(onSuccess, onError, args) {
  var self = this;
  var overlayId = args[0];
  var marker = self.pluginMap.objects[overlayId];
  if (marker) {
...
PluginTileOverlay.prototype._onMarkerEvent = function(marker, evtName) {
  var self = this,
