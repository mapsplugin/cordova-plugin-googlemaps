...
PluginGroundOverlay.prototype.setTitle = function(onSuccess, onError, args) {
  var self = this;
...
PluginGroundOverlay.prototype.showInfoWindow = function(onSuccess, onError, args) {
  var self = this;
  var overlayId = args[0];
  var marker = self.pluginMap.objects[overlayId];
  if (marker) {
...
PluginGroundOverlay.prototype.setPosition = function(onSuccess, onError, args) {
  var self = this;
  var overlayId = args[0];
  var marker = self.pluginMap.objects[overlayId];
  if (marker) {
...
PluginGroundOverlay.prototype._onMarkerEvent = function(marker, evtName) {
  var self = this,
